...
import com.hx.mis.dao.NationTableDao;
import com.hx.mis.dao.NativeTableDao;
...
//	private static final double LEFT_WIDTH = 0.6;
	...
	public void reinit() {
		...
		List<NativeModel> nativeList = new NativeTableDao().getNatives();
		for (NativeModel nativeModel : nativeList) {
			jcmbNative.addItem(nativeModel);
		}
		
		jcmbNation.removeAllItems();
		List<NationModel> nationList = new NationTableDao().getNations();
