...
@Component
@Transactional
public class StudentDao implements ISession {
	@Autowired
	...
	public StudentBaseInfo getStudentBaseInfoByPeopleId(String peopleId) {
		Session session = getSession(sessionFactory);
		@SuppressWarnings("unchecked")
		List<StudentBaseInfo> studentList = session.createQuery(
				" FROM StudentBaseInfo stu"
				+ " WHERE stu.peopleId = '" + peopleId + "'").getResultList();
		StudentBaseInfo student = studentList.get(0);
