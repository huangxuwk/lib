...
import com.dl.serialException.ExceptionWriter;
...
public class DataView extends Frame {
	 ...
	 * @param client
	 */
	public DataView(ClientFirst client) {
		this.client = client;
...
//		if (offScreen == null)	offScreen = this.createImage(ClientFirst.WIDTH, ClientFirst.HEIGHT);
		Graphics gOffScreen = offScreen.getGraphics();
		Color c = gOffScreen.getColor();
		gOffScreen.setColor(Color.white);
//		gOffScreen.fillRect(0, 0, ClientFirst.WIDTH, ClientFirst.HEIGHT);	//重画背景画布
